...
def main(argv):
    ...
    print("--> KenKen Solver <--")
    #size_1, number_cage = test_gen.generate(2)
    #print(number_cage)
    if len(sys.argv) != 3:
        error_exit("Wrong number of command line parameters was given.") 
    input_file_num = sys.argv[1]
    if input_file_num == '3':
         input_file='kenken3.txt'
    elif input_file_num == '4':
         input_file='kenken4a.txt'
    elif input_file_num == '5':
         input_file='kenken5.txt'
    elif input_file_num == '6':
         input_file='kenken6.txt'
    elif input_file_num == '7':
         input_file='kenken7.txt'
